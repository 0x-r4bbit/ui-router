NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "shortName": "ui-view",
      "type": "directive",
      "keywords": "$anchorscroll $compile $controller $injector $state api be can directive diretive eca name named or place router state tells templates the to ui ui-view unnamed view where your"
    },
    {
      "section": "api",
